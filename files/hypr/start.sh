...
# Wait up to 10 seconds for the correct Discord window
for i in {1..100}; do
...
if [[ -z "$discord" ]]; then
  echo "[ERROR] Discord window not found" >&2
  exit 1
fi

# Get other window addresses
